...
// 1. Define the structure of your GLTF result
...
// We extend React.ComponentPropsWithoutRef<'group'> to allow scale, position, etc.
interface ModelProps extends React.ComponentPropsWithoutRef<'group'> {
  item: {
    img: string;
    color: string[];
  };
  size: string; // Add this to resolve the TS error in ModelView
}

const Model: React.FC<ModelProps> = (props) => {
  // Destructure size and item, passing the rest to the group
