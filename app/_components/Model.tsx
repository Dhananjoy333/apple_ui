...
function Model() {
    ...
    const cameraControlSmall = useRef<OrbitControlsType | null>(null)
    const cameraControlLarge = useRef<OrbitControlsType | null>(null)
  ...
  return (
    <section ref={wrapperRef} className="common-padding">
